...
var pstMG = [6][64]int{
	P: {
		 ...
		 105,  96,  65,  69,  76,  69,  26, -11,
		   0,   0,   0,   0,   0,   0,   0,   0,
	},
	N: {
		 -96,   8, -39, -28,  12, -11,  12, -24,
		 -15, -62,  -1,  15,  18,  29,  -2,  -4,
		 -15,   4,  18,  19,  42,  27,  31, -15,
		  -2,   3,  16,  21,  39,  22,  22,   9,
		  -9,  22,  10,  57,  33,  80,  21,  25,
		 -42,  57,  32,  62,  90, 128,  87,  44,
		 -73, -34,  70,  30,  29,  69,   8,   6,
		-172, -81, -31, -35,  68, -97,  -7, -96,
	},
	...
	R: {
		  -4,  -9,   0,   4,   7,   9, -28,  -5,
		 -29, -15, -26, -10,   2,  13, -10, -60,
		 -40, -20, -22, -32,  -2,   1,  10, -29,
		 -31, -36, -30,  -4,   8, -16,   3, -21,
		 -23, -21,   1,  22,  13,  39, -10, -22,
		  -4,  22,  18,  32,  21,  47,  64,   4,
		  26,  35,  48,  55,  84,  73,  37,  43,
		  19,  43,  33,  55,  66,  15,  28,  41,
	},
	Q: {
		   8, -11,  -6,  23, -10, -27, -41, -39,
		 -26,   0,  18,   5,  18,  18,   1,  18,
		  -8,  10,  -8,  -1,  -8,  -6,  17,  11,
		   4, -36, -14, -22,  -3,  -7,   9,   3,
		 -28, -30, -17, -18, -15,   5,   5,   1,
		 -10, -17,  12,  -3,  32,  66,  46,  57,
		 -19, -53,  -7,   0, -19,  54,  34,  64,
		 -16,  10,  29,   8,  66,  39,  44,  56,
	},
	K: {
...
var pstEG = [6][64]int{
	P: {
		   0,   0,   0,   0,   0,   0,   0,   0,
		   9, -14,  -1,  -5,   4, -11, -29, -15,
		  -7, -13, -19, -10, -13, -17, -34, -15,
		   8, -11, -14, -26, -23, -26, -23,  -7,
		  29,   3,   2, -17, -20, -10,  -5,  10,
		  92,  89,  71,  43,  28,  27,  56,  72,
		 153, 133, 126,  97, 100, 104, 123, 165,
		   0,   0,   0,   0,   0,   0,   0,   0,
	},
	N: {
		 -21, -41,  -2,  -1,  -9,   2, -44, -50,
		 -25,   0,   0,  -1,   4,  -6,   0, -32,
		  -2,   4,   2,  19,   5,  -2, -10,   3,
		  -5,   1,  22,  31,  15,  18,   7, -10,
		  -3,  15,  27,  15,  27,   2,  17,  -7,
		 -25, -12,  10,   5,  -3, -18, -22, -43,
		 -12,   0, -22,  10,  -6, -22, -18, -53,
		 -30, -26,   6, -23, -16, -14, -66, -76,
	},
	B: {
		  -9,   3, -23,   1,   0, -12,   6,  -5,
		 -14, -23, -13,  -1,   3,   1, -15, -17,
		  -8,  -7,   6,   7,   8,  -5,  -7,  -6,
		   1,  -3,   4,   5,  -6,   5,  -6,   5,
		   6,   5,   7,  -9,  -4,  -6,  -2,   5,
		   8,  -9, -10, -15, -13,  -9,   2,   6,
		   5, -11,  11, -14,  -5, -18,  -5, -13,
		  -1, -19,   0, -12,   1,   6, -10,  -8,
	},
	R: {
		   2,  11,  18,   9,   5,   7,  18, -12,
		  ...
		  16,  14,   4,  16,  -2,  -1,  -5,   4,
		  19,  24,  22,   9,   1,   9,   3,   0,
		  16,  20,  21,   6,  10,   4,  13,  13,
		  24,  11,  14,   7,   7,  -8,  -1,   8,
		  25,  20,  13,  11,  -4,   2,  15,  15,
		  21,  11,  21,  14,  16,  22,  17,  16,
	},
	Q: {
		 -42, -26, -14, -50,  13, -23,  -2, -46,
		 -11, -15, -23,  -5, -13, -18, -26, -20,
		 -11, -37,  19,   4,  21,  27,  16,  21,
		 -14,  52,  31,  52,  39,  39,  37,  38,
		  17,  37,  25,  47,  75,  46,  63,  47,
		 -19,  12,  12,  49,  44,  32,  18,   0,
		 -11,  32,  42,  52,  70,  33,  28,  -2,
		   2,  33,  37,  33,  30,  44,  16,  30,
	},
	K: {
...
var passedBonusMG = [2][8]int{
        0: {0, 25, 20, -6, 5, 15, 23, 0}, // free: push square empty
        1: {0, 17, 23, 1, 17, 15, 27, 0}, // blocked: push square occupied
}
var passedBonusEG = [2][8]int{
        0: {0, 19, 23, 7, 35, 61, 84, 0}, // free
        1: {0, 20, 29, -6, 18, -11, -22, 0}, // blocked
}
